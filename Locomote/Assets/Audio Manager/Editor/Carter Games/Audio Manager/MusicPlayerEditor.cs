...
namespace CarterGames.Assets.AudioManager
{
    ...
    public class MusicPlayerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            musicTrack.objectReferenceValue = (AudioClip)EditorGUILayout.ObjectField(musicTrack.objectReferenceValue, typeof(AudioClip), false);
            EditorGUILayout.EndHorizontal();
            ...
            playOnAwake.boolValue = EditorGUILayout.Toggle(playOnAwake.boolValue);
            EditorGUILayout.EndHorizontal();
            ...
            pitch.floatValue = EditorGUILayout.FloatField(pitch.floatValue);
            EditorGUILayout.EndHorizontal();
            ...
            shouldLoop.boolValue = EditorGUILayout.Toggle(shouldLoop.boolValue);
            EditorGUILayout.EndHorizontal();
            
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Start Track At:", GUILayout.MaxWidth(140f));
            timeToStartFrom.floatValue = EditorGUILayout.FloatField(timeToStartFrom.floatValue);
            EditorGUILayout.EndHorizontal();
            
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Loop Track At:", GUILayout.MaxWidth(140f));
            timeToLoopAt.floatValue = EditorGUILayout.FloatField(timeToLoopAt.floatValue);
            EditorGUILayout.EndHorizontal();
            ...
            if (!showSource.boolValue)
            {
                ...
                if (GUILayout.Button("Show Audio Source", GUILayout.Width(140f)))
                {
                    player.GetComponent<AudioSource>().hideFlags = HideFlags.None;
            ...
            else
            {
                ...
                if (GUILayout.Button("Hide Audio Source", GUILayout.Width(140f)))
                {
                    player.GetComponent<AudioSource>().hideFlags = HideFlags.HideInInspector;
